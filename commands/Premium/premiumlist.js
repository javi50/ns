...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    try {
      ...
      if (!args[0]) {
        let guildembed = new MessageEmbed().setColor("BLUE").setFooter(client.user.username + " | by: milrato.eu", client.user.displayAvatarURL())
        ...
        let userembed = new MessageEmbed().setColor("BLUE").setFooter(client.user.username + " | by: milrato.eu", client.user.displayAvatarURL())
