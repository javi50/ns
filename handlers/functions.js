...
module.exports = {
  ...
  */
  ...
  stations: function (client, prefix, message) {
    try {
      let amount = 0;
      const stationsembed = new Discord.MessageEmbed().setColor("BLUE").setFooter(client.user.username + " | by: milrato.eu", client.user.displayAvatarURL()).setTitle("Pick your Station, by typing in the right `INDEX` Number!").setDescription("Example: `?radio 11`");
      const stationsembed2 = new Discord.MessageEmbed().setColor("BLUE").setFooter(client.user.username + " | by: milrato.eu", client.user.displayAvatarURL()).setTitle("Pick your Station, by typing in the right `INDEX` Number!").setDescription("Example: `?radio 69`");
      const stationsembed3 = new Discord.MessageEmbed().setColor("BLUE").setFooter(client.user.username + " | by: milrato.eu", client.user.displayAvatarURL()).setTitle("Pick your Station, by typing in the right `INDEX` Number!").setDescription("Example: `?radio 180`");
      let United_Kingdom = "";
          ...
          return setTimeout(() => {
            try {
              ...
              if (player.queue.size === 0) {
                ...
                try {
                  embed.setFooter(client.user.username + " | by: milrato.eu", client.user.displayAvatarURL());
                } catch {}
    ...
    try {
      ...
      function reset(track_info_msg, queue_info_msg) {
        let embed2 = new MessageEmbed()
          .setColor("BLUE")
          .setFooter(`Prefix for this Server is:   ${client.settings.get(track_info_msg.guild.id, "prefix")}`, client.user.displayAvatarURL())
